...
describe '#attr_accessor_with_history' do
  shared_examples 'all cases' do
    it 'should define getter and setter [5 points]', points: 5 do
      @subject.foo = 'xyz'
      @subject.foo.should == 'xyz'
    end
    it 'setter should return value set to [5 points]', points: 5 do
    ...
    it 'should remember values [10 points]', points: 10 do
      @subject.foo
      @subject.foo = 3
      @subject.foo = 'x'
  ...
  describe 'when a symbol is passed [10 points]', points: 10 do
  ...
  it 'should remember history separately for each instance [30 points]', points: 30 do
    obj1 = TestClass1.new
    obj2 = TestClass1.new
